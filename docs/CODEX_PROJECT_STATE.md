...
16. Firebase runtime sign-in recovery:
   - The current staging ngrok hostname was added to `gravity-authe` Authorized Domains after real browser sign-in returned Firebase auth errors.
